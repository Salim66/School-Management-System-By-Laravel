          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Edit Student Group</h3>
                <a href="{{ route('view.student.group') }}" class="btn btn-rounded btn-success float-right">View Student Group</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="row">
                  <div class="col">
                      <form novalidate method="POST" action="{{ route('student.group.update', $data->id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-6">
