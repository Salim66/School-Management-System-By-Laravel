          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Create Fee Category</h3>
                <a href="{{ route('view.fee.category') }}" class="btn btn-rounded btn-success float-right">View Fee Category</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="row">
                  <div class="col">
                      <form novalidate method="POST" action="{{ route('fee.category.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-6">
