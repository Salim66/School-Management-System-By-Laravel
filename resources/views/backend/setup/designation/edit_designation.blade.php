          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                ...
                <a href="{{ route('view.designation') }}" class="btn btn-rounded btn-success float-right">View Designation</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="row">
                  <div class="col">
                      <form novalidate method="POST" action="{{ route('designation.update', $data->id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-6">
