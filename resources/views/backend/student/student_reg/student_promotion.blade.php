          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Promotion Student</h3>
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col">
                      <form novalidate method="POST" action="{{ route('student.reg.promotion.update', $data->student_id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-4">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                   <input type="submit" class="btn btn-rounded btn-primary" value="Promotion">
                                </div>
                            </div>
                        </div>
                      </form>
