                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="salary" class="form-control" required data-validation-required-message="This field is required"> </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" name="join_date" class="form-control" required data-validation-required-message="This field is required"> </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
